...
function CopyBlock({ label, code }: { label: string; code: string }) {
  ...
  return (
    <div style={{ background: 'var(--bg-primary)', border: '1px solid var(--border-primary)', borderRadius: 12, overflow: 'hidden', marginBottom: 16 }}>
      ...
      <pre style={{ margin: 0, padding: '14px 16px', color: 'var(--text-secondary)', fontSize: '.85em', lineHeight: 1.7, overflowX: 'auto', whiteSpace: 'pre-wrap', wordBreak: 'break-all' }}>
        {code}
      </pre>
    </div>
  )
  ...
  return (
    <main style={{ maxWidth: 720, margin: '0 auto', padding: '64px 24px', color: '#e0e0e0', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 56 }}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '1.05em', lineHeight: 1.7, maxWidth: 520, margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: 40 }}>
        ...
        <div style={{ marginTop: 12, padding: '12px 16px', background: '#1a1000', border: '1px solid #f59e0b44', borderRadius: 8, fontSize: '.83em', color: 'var(--text-muted)' }}>
          ...
          <div style={{ marginTop: 8, color: 'var(--text-secondary)', fontFamily: 'monospace', background: 'var(--bg-primary)', padding: '8px 12px', borderRadius: 6 }}>
      ...
      {/* Step 3 */}
      <div style={{ marginBottom: 56, background: 'var(--bg-primary)', border: '1px solid var(--border-primary)', borderRadius: 12, padding: '24px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
      ...
      <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
        ...
        <Link href="/skills" style={{ padding: '12px 24px', background: 'var(--bg-primary)', border: '1px solid var(--border-primary)', borderRadius: 10, color: 'var(--text-muted)', textDecoration: 'none', fontSize: '.9em' }}>
