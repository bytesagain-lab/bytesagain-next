...
const ALIEXPRESS_DEALS = {
  global: { label: 'Sunshine Savings — Global', valid_until: '2026-05-22 23:59 PST', banner: 'Up to 60% off — May 18-22! *Not available in DE, RU, BE, FI, PT, BH, DK, UA, FR, HU, SA, QA, BR, SE, UK, BY, MD, KG, IE, GE, OM, CA, US, IL, AE, UZ, CH, KR, MX, IT, AM, KW, ES, KZ, AT, AU, TJ, CZ, AZ, TM, PL, NL, PE, CO, AR', codes: [
    { code: 'AFSS2', desc: '$15-$2' },
    { code: 'AFSS4', desc: '$30-$4' },
  ...
  us: { label: 'Sunshine Savings — US', valid_until: '2026-05-22 23:59 PST', banner: 'Extra codes: up to $90 off!', codes: [
    { code: 'USAFF2', desc: '$18-$2' },
    { code: 'USAFF5', desc: '$39-$5' },
    { code: 'USAFF12', desc: '$85-$12' },
    { code: 'USAFF24', desc: '$165-$24' },
    { code: 'USAFF35', desc: '$249-$35' },
    { code: 'USAFF55', desc: '$379-$55' },
    { code: 'USAFF70', desc: '$499-$70' },
    { code: 'USAFF90', desc: '$599-$90' },
  ],
  new_user_codes: { label: 'US New Users', valid_until: '2026-06-30', codes: [
    { code: 'NEWUSOFF3', desc: '$10-$3' },
    { code: 'NEWUSOFF5', desc: '$20-$5' },
    { code: 'NEWUSOFF12', desc: '$80-$12' },
  ]}},
  br: { label: 'Geek Pride Sale — Brazil', valid_until: '2026-05-22 23:59 BRT', banner: 'Up to 70% off, Under US$50, R$800+ in codes', codes: [
    { code: 'GEEK01', desc: 'R$90-R$12' },
    { code: 'GEEK02', desc: 'R$180-R$24' },
    { code: 'GEEK03', desc: 'R$300-R$38' },
    { code: 'GEEK04', desc: 'R$640-R$80' },
    { code: 'GEEK05', desc: 'R$1150-R$135' },
    { code: 'GEEK06', desc: 'R$1760-R$240' },
  ...
  fr: { label: 'Économies ensoleillées — France', valid_until: '2026-05-22 23:59 CET', codes: [
    ...
    { code: 'SSFR05', desc: '€39-€5' },
    { code: 'SSFR11', desc: '€79-€11' },
    { code: 'SSFR20', desc: '€139-€20' },
    { code: 'SSFR30', desc: '€239-€30' },
    { code: 'SSFR45', desc: '€359-€45' },
    { code: 'SSFR60', desc: '€479-€60' },
  ]},
  ...
  de: { label: 'Sunshine Savings — Germany', valid_until: '2026-05-22 23:59 CEST', banner: 'Bis zu 60% Rabatt, Kostenloser Versand', codes: [
    ...
    { code: 'SSDE05', desc: '€39-€5' },
    { code: 'SSDE11', desc: '€79-€11' },
    { code: 'SSDE20', desc: '€139-€20' },
    { code: 'SSDE30', desc: '€239-€30' },
    { code: 'SSDE45', desc: '€359-€45' },
    { code: 'SSDE60', desc: '€479-€60' },
  ]},
  pl: { label: 'Sunshine Savings — Poland', valid_until: '2026-05-22 23:59 CET', codes: [
    { code: 'AEPL2', desc: '$18-$2' },
    { code: 'AEPL5', desc: '$39-$5' },
    { code: 'AEPL11', desc: '$79-$11' },
    { code: 'AEPL17', desc: '$119-$17' },
    { code: 'AEPL30', desc: '$239-$30' },
    { code: 'AEPL45', desc: '$359-$45' },
    { code: 'AEPL70', desc: '$559-$70' },
  ]},
  ua: { label: 'Sunshine Savings — Ukraine', valid_until: '2026-05-22 23:59 CET', codes: [
    { code: 'AEUA01', desc: '$10-$1' },
    { code: 'AEUA03', desc: '$25-$3' },
    { code: 'AEUA05', desc: '$40-$5' },
    { code: 'AEUA10', desc: '$79-$10' },
    { code: 'AEUA18', desc: '$139-$18' },
    { code: 'AEUA30', desc: '$229-$30' },
  ...
  it: { label: 'Offerte radiose — Italy', valid_until: '2026-05-22 23:59 CET', codes: [
    ...
    { code: 'ITSS05', desc: '€39-€5' },
    { code: 'ITSS11', desc: '€79-€11' },
    { code: 'ITSS20', desc: '€139-€20' },
    { code: 'ITSS30', desc: '€239-€30' },
    { code: 'ITSS45', desc: '€359-€45' },
    { code: 'ITSS60', desc: '€479-€60' },
  ]},
  euro_multi: { label: 'Sunshine Savings — AT/BE/CH/CZ/DK/FI/HU/IE/PT/SE', valid_until: '2026-05-22 23:59 CET', codes: [
    { code: 'SSVIO02', desc: '€18-€2' },
    { code: 'SSVIO05', desc: '€39-€5' },
    { code: 'SSVIO11', desc: '€79-€11' },
    { code: 'SSVIO20', desc: '€139-€20' },
    { code: 'SSVIO30', desc: '€239-€30' },
    { code: 'SSVIO45', desc: '€359-€45' },
    { code: 'SSVIO60', desc: '€479-€60' },
  ]},
  uk: { label: 'Sunshine Savings — UK', valid_until: '2026-05-22 22:59 BST', codes: [
    { code: 'AEUKSSX2', desc: '£15-£2' },
    { code: 'AEUKSSX4', desc: '£30-£4' },
    { code: 'AEUKSSX9', desc: '£65-£9' },
    { code: 'AEUKSS15', desc: '£120-£15' },
    { code: 'AEUKSS25', desc: '£209-£25' },
    { code: 'AEUKSS45', desc: '£329-£40' },
    { code: 'AEUKSS55', desc: '£449-£55' },
  ],
  new_user_codes: { label: 'UK New Users', valid_until: '2026-07-09', codes: [
    { code: 'UKNEW03', desc: '£7-£3' },
    { code: 'UKNEW04', desc: '£15-£4' },
  ]}},
  au: { label: 'Seasonal Savings — Australia', valid_until: '2026-05-22 23:59 PST', banner: 'Up to 60% off with up to 80 AUD off!', codes: [
    { code: 'AFFAU03', desc: 'A$22-A$3' },
    { code: 'AFFAU06', desc: 'A$44-A$6' },
    { code: 'AFFAU13', desc: 'A$95-A$13' },
    { code: 'AFFAU21', desc: 'A$169-A$21' },
    { code: 'AFFAU35', desc: 'A$295-A$35' },
    { code: 'AFFAU58', desc: 'A$480-A$58' },
    { code: 'AFFAU80', desc: 'A$650-A$80' },
  ]},
  ca: { label: 'Sunshine Savings — Canada', valid_until: '2026-05-22 23:59 PDT', codes: [
    { code: 'AECA15', desc: 'C$3 off C$22' },
    { code: 'AECA30', desc: 'C$6 off C$45' },
    { code: 'AECA65', desc: 'C$13 off C$95' },
    { code: 'AECA120', desc: 'C$21 off C$169' },
    { code: 'AECA209', desc: 'C$36 off C$300' },
  ...
  mx: { label: 'Spring Refresh — Mexico', valid_until: '2026-05-22 23:59 CT', banner: 'Save 3075 MXN+ with codes, up to 60% off. DIDI Pay new users: MXN100-MXN50, MXN280-MXN140, MXN480-MXN240, MXN980-MXN490', codes: [
    ...
    { code: 'MXSS4', desc: 'MX$2500-MX$360' },
    { code: 'MXSS5', desc: 'MX$4200-MX$520' },
  ...
  gcc: { label: 'Sunshine Savings — GCC (SA/AE/KW/OM/BH/QA)', valid_until: '2026-05-22 23:59 PST', banner: 'Exclusive codes valid 18th-22nd May', codes: [
    ...
    { code: 'GCC4', desc: '500 SAR-62 SAR' },
    { code: 'GCC5', desc: '920 SAR-115 SAR' },
    { code: 'GCC6', desc: '1430 SAR-175 SAR' },
    { code: 'GCC7', desc: '1960 SAR-243 SAR' },
  ]},
}
