...
const ZH_MAP: Record<string, string> = {
  ...
  '邮件': 'email',
  '数据分析': 'data analysis',
  '数据可视化': 'data visualization chart dashboard BI',
  '图表': 'chart dashboard visualization BI',
  '仪表盘': 'dashboard BI KPI chart',
  '看板': 'dashboard BI KPI chart',
  '报表': 'report dashboard BI chart',
  '生成superset': 'BI dashboard chart Superset SQL visualization',
  'superset图表': 'BI dashboard chart Superset SQL visualization',
  'superset': 'BI dashboard chart Superset SQL visualization',
  ...
  '健身': 'fitness workout',
  '减肥': 'weight loss diet',
  '电商': 'ecommerce product listing optimization shopify amazon marketplace',
  '商品listing': 'ecommerce product listing optimization marketplace SEO',
  '商品列表': 'ecommerce product listing optimization marketplace SEO',
  '商品标题': 'product title optimization ecommerce listing SEO',
  '商品描述': 'product description ecommerce listing SEO',
  '商品上架': 'ecommerce product listing publish marketplace shopify',
  '独立站上架': 'shopify product listing ecommerce SEO',
  '亚马逊listing': 'amazon product listing title bullets keywords SEO',
  '淘宝': 'taobao ecommerce marketplace product listing',
...
const EN_EXPAND: Record<string, string> = {
  ...
  'ecommerce product listing': 'ecommerce product listing optimization shopify amazon SEO',
  'product listing optimization': 'ecommerce product listing optimization shopify amazon SEO',
  'amazon listing': 'amazon product listing title bullets keywords SEO',
  'shopify product page': 'shopify product listing ecommerce SEO',
  'shopify listing': 'shopify product listing ecommerce SEO',
  'product description': 'product description ecommerce listing SEO',
  'marketplace listing': 'ecommerce product listing marketplace SEO',
  ...
  'bi dashboard': 'BI dashboard chart SQL visualization',
  'business intelligence': 'BI dashboard chart SQL visualization',
  'superset': 'BI dashboard chart Superset SQL visualization',
  'superset chart': 'BI dashboard chart Superset SQL visualization',
  'dashboard chart': 'dashboard chart BI visualization',
