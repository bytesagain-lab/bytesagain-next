    ...
    <div style={{ maxWidth: 420, margin: '80px auto', padding: '0 20px' }}>
      <div style={{ background: 'var(--bg-secondary)', border: '1px solid var(--border-primary)', borderRadius: 16, padding: 36 }}>
        ...
        <button onClick={googleLogin} style={{
          ...
          padding: '11px 0', borderRadius: 8, border: '1px solid var(--border-input)',
          color: 'var(--text-nav)', fontSize: '.9em', background: 'var(--bg-input)', cursor: 'pointer', marginBottom: 20,
        }}>
        ...
        {/* 模式切换 tabs */}
        <div style={{ display: 'flex', gap: 4, marginBottom: 20, background: 'var(--bg-input)', borderRadius: 8, padding: 4 }}>
          {tabs.map(t => (
