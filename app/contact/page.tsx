...
export default function ContactPage() {
  return (
    <div style={{ maxWidth: 600, margin: '60px auto', padding: '0 20px', textAlign: 'center' }}>
      ...
      <p style={{ color: 'var(--text-muted)', marginBottom: 40, lineHeight: 1.8 }}>Have a question, suggestion, or partnership inquiry? We'd love to hear from you.</p>
      {[
        ...
        <div key={label} style={{ background: 'var(--bg-secondary)', border: '1px solid var(--border-primary)', borderRadius: 14, padding: '20px 24px', marginBottom: 16, display: 'flex', alignItems: 'center', gap: 16, textAlign: 'left' }}>
