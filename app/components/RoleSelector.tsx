...
const SKILL_PACKS: Record<string, { slug: string; name: string; reason: string }[]> = {
  ...
  photographer:     [{ slug: 'image-cog', name: 'Image Tools', reason: 'Edit & enhance' }, { slug: 'creative-toolkit', name: 'AI Image Generator', reason: 'Creative assets' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Shoot planning' }],,
  ...
  parent:           [{ slug: 'story-teller', name: 'Story Teller', reason: 'Bedtime stories' }, { slug: 'bedtime-radio', name: 'Bedtime Radio', reason: 'Kids audio stories' }, { slug: 'flashcards', name: 'Flashcard Maker', reason: 'Kids learning' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Family schedule' }],,
