...
const SKILL_PACKS: Record<string, { slug: string; name: string; reason: string }[]> = {
  ...
  social:           [{ slug: 'story-writer', name: 'Story Writer', reason: 'Captions & threads' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Posting schedule' }, { slug: 'seo-optimization', name: 'GEO SEO', reason: 'AI discoverability' }, { slug: 'clawhub-hashtag-generator', name: 'Hashtag Generator', reason: 'Reach more people' }],
