...
const SKILL_PACKS: Record<string, { slug: string; name: string; reason: string }[]> = {
  ...
  'customer-support':[{ slug: 'clawhub-ticket-monitor-ichinosuke', name: 'Ticket Monitor', reason: 'Track and manage support tickets automatically' }, { slug: 'translator-pro', name: 'Translator Pro', reason: 'Handle multi-language customer inquiries' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Organize support workflows and priorities' }, { slug: 'clawhub-email-automation', name: 'Email Automation', reason: 'Auto-respond and route customer emails' }],
  ...
  social:           [{ slug: 'clawhub-content-calendar', name: 'Content Calendar', reason: 'Content calendar' }, { slug: 'clawhub-twitter-thread-creation', name: 'Twitter Threads', reason: 'Twitter thread writer' }, { slug: 'clawhub-instagram-caption-scraper', name: 'Instagram Captions', reason: 'Caption generator' }, { slug: 'image-prompt', name: 'Image Prompt', reason: 'Visual content creation with AI image prompts' }],
  ...
  'video-editor':   [{ slug: 'clawhub-nemo-subtitle', name: 'Nemo Subtitle', reason: 'Auto-generate accurate subtitles for videos' }, { slug: 'video-toolbox', name: 'Video Toolbox', reason: 'All-in-one video editing and processing tools' }, { slug: 'clawhub-bilibili-video-transcribe-summary', name: 'Video Transcribe', reason: 'Transcribe and summarize video content' }, { slug: 'caption', name: 'Caption Generator', reason: 'Generate engaging captions for social media videos' }, { slug: 'subtitle-translator', name: 'Subtitle Translator', reason: 'Translate subtitles into multiple languages' }],
  ...
  'game-dev':       [{ slug: 'code-generator', name: 'Code Generator', reason: 'Generate game logic and scripts' }, { slug: 'clawhub-senseaudio-game-npc-director', name: 'NPC Director', reason: 'Create dynamic NPC dialogue and behavior' }, { slug: 'story-writer', name: 'Story Writer', reason: 'Write compelling game narratives and lore' }, { slug: 'clawhub-english-game', name: 'English Game', reason: 'Build language-learning game mechanics' }],
  ...
  'data-scientist': [{ slug: 'system-data-intelligence-skill', name: 'Data Intelligence', reason: 'End-to-end data analysis and reporting' }, { slug: 'clawhub-chart-py-generator', name: 'Chart Generator', reason: 'Generate Python charts from data' }, { slug: 'data-analysis', name: 'Data Analysis', reason: 'Statistical analysis and insight extraction' }, { slug: 'clawhub-chartmaker', name: 'Chart Maker', reason: 'Create professional charts for presentations' }],
  ...
  'job-seeker':     [{ slug: 'interview-analysis', name: 'Interview Analysis', reason: 'Analyze and prepare for job interviews with AI' }, { slug: 'clawhub-ai-interview-system', name: 'AI Interview System', reason: 'Practice interviews with AI coaching' }, { slug: 'resume-writer', name: 'Resume Writer', reason: 'Create compelling resumes and cover letters' }, { slug: 'translator-pro', name: 'Translator Pro', reason: 'Translate job applications for international roles' }],
}
