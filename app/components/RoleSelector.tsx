...
const SKILL_PACKS: Record<string, { slug: string; name: string; reason: string }[]> = {
  ...
  designer:         [{ slug: 'story-writer', name: 'Story Writer', reason: 'UX copy & specs' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Project management' }, { slug: 'translator-pro', name: 'Translator Pro', reason: 'Multi-language assets' }, { slug: 'superdesign', name: 'Figma to Code', reason: 'Design handoff' }],
  product:          [{ slug: 'task-planner', name: 'Task Planner', reason: 'Roadmap & prioritization' }, { slug: 'story-writer', name: 'Story Writer', reason: 'PRDs & specs' }, { slug: 'database-design', name: 'Database Design', reason: 'Data modeling' }, { slug: 'brainstorming', name: 'User Story Generator', reason: 'Agile sprints' }],
  marketer:         [{ slug: 'seo-optimization', name: 'GEO SEO', reason: 'Rank in AI search' }, { slug: 'story-writer', name: 'Story Writer', reason: 'Ad copy & emails' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Campaign management' }, { slug: 'translator-pro', name: 'Translator Pro', reason: 'Global campaigns' }],
  seo:              [{ slug: 'seo-optimization', name: 'GEO SEO', reason: 'AI search optimization' }, { slug: 'story-writer', name: 'Story Writer', reason: 'SEO content' }, { slug: 'clawhub-sitemap-generator', name: 'Sitemap Generator', reason: 'Technical SEO' }, { slug: 'clawhub-keyword-research', name: 'Keyword Research', reason: 'Topic discovery' }],
  sales:            [{ slug: 'story-writer', name: 'Story Writer', reason: 'Proposals & outreach' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Pipeline management' }, { slug: 'translator-pro', name: 'Translator Pro', reason: 'International clients' }, { slug: 'cold-email-writer', name: 'Email Writer', reason: 'Cold outreach' }],
  hr:               [{ slug: 'story-writer', name: 'Story Writer', reason: 'Job descriptions & emails' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Hiring pipeline' }, { slug: 'legal-advisor', name: 'Legal Advisor', reason: 'Contract basics' }, { slug: 'resume-screening', name: 'Resume Screener', reason: 'Fast shortlisting' }],
  legal:            [{ slug: 'legal-advisor', name: 'Legal Advisor', reason: 'Contract review' }, { slug: 'story-writer', name: 'Story Writer', reason: 'Legal drafts' }, { slug: 'gdpr-compliance-tracker', name: 'GDPR Compliance', reason: 'Privacy checks' }, { slug: 'translator-pro', name: 'Translator Pro', reason: 'Multi-jurisdiction' }],
  ...
  ecommerce:        [{ slug: 'story-writer', name: 'Story Writer', reason: 'Product descriptions' }, { slug: 'excel-formula', name: 'Excel Formula', reason: 'Inventory tracking' }, { slug: 'translator-pro', name: 'Translator Pro', reason: 'Sell globally' }, { slug: 'seo-optimization', name: 'GEO SEO', reason: 'Product discoverability' }],
  freelancer:       [{ slug: 'story-writer', name: 'Story Writer', reason: 'Proposals & pitches' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Client management' }, { slug: 'legal-advisor', name: 'Legal Advisor', reason: 'Contracts & invoices' }, { slug: 'agent-task-tracker', name: 'Time Tracker', reason: 'Billable hours' }],
  founder:          [{ slug: 'task-planner', name: 'Task Planner', reason: 'Execution & OKRs' }, { slug: 'story-writer', name: 'Story Writer', reason: 'Pitch decks & fundraising' }, { slug: 'seo-optimization', name: 'GEO SEO', reason: 'Organic growth' }, { slug: 'monte-carlo', name: 'Monte Carlo', reason: 'Scenario planning' }, { slug: 'legal-advisor', name: 'Legal Advisor', reason: 'Cap table & terms' }],
  consultant:       [{ slug: 'story-writer', name: 'Story Writer', reason: 'Reports & decks' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Engagement management' }, { slug: 'chart-image', name: 'Chart Generator', reason: 'Data storytelling' }, { slug: 'translator-pro', name: 'Translator Pro', reason: 'Global clients' }],
  ...
  podcaster:        [{ slug: 'story-writer', name: 'Story Writer', reason: 'Episode outlines' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Guest & schedule mgmt' }, { slug: 'whisper-audio-transcription', name: 'Audio Transcriber', reason: 'Show notes auto' }],
  social:           [{ slug: 'story-writer', name: 'Story Writer', reason: 'Captions & threads' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Posting schedule' }, { slug: 'seo-optimization', name: 'GEO SEO', reason: 'AI discoverability' }, { slug: 'enteriva-ai-social-hub', name: 'Social Hub', reason: 'Reach more people' }],
  newsletter:       [{ slug: 'story-writer', name: 'Story Writer', reason: 'Issue writing' }, { slug: 'seo-optimization', name: 'GEO SEO', reason: 'Grow subscribers' }, { slug: 'cold-email-writer', name: 'Email Writer', reason: 'Subject lines' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Editorial calendar' }],
  ...
  photographer:     [{ slug: 'story-writer', name: 'Story Writer', reason: 'Client briefs & captions' }, { slug: 'image-cog', name: 'Image Tools', reason: 'SEO for photos' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Shoot planning' }],
  musician:         [{ slug: 'story-writer', name: 'Story Writer', reason: 'Lyrics & bios' }, { slug: 'ascii-chord', name: 'Chord Progression', reason: 'Music theory help' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Release planning' }],
  'game-dev':       [{ slug: 'code-generator', name: 'Code Generator', reason: 'Game logic' }, { slug: 'debugger', name: 'Debugger', reason: 'Fix runtime errors' }, { slug: 'story-writer', name: 'Story Writer', reason: 'Game narrative & lore' }, { slug: 'game-cog', name: 'Unity Helper', reason: 'Unity scripts' }],
  ...
  // Learn
  student:          [{ slug: 'code-generator', name: 'Code Generator', reason: 'See working examples' }, { slug: 'debugger', name: 'Debugger', reason: 'Understand errors' }, { slug: 'shell', name: 'Shell Toolkit', reason: 'Learn the terminal' }, { slug: 'flashcards', name: 'Flashcard Maker', reason: 'Active recall' }],
  ...
  teacher:          [{ slug: 'story-writer', name: 'Story Writer', reason: 'Lesson plans & materials' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Curriculum planning' }, { slug: 'quiz-generator-cp3d', name: 'Quiz Generator', reason: 'Auto assessment' }, { slug: 'translator-pro', name: 'Translator Pro', reason: 'Multilingual students' }],
  ...
  // Life
  traveler:         [{ slug: 'translator-pro', name: 'Translator Pro', reason: 'Communicate anywhere' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Trip itinerary' }, { slug: 'ai-travel-planner-cn', name: 'Travel Planner', reason: 'Flights & hotels' }, { slug: 'story-writer', name: 'Story Writer', reason: 'Travel journaling' }],
  cook:             [{ slug: 'cooking-recipe', name: 'Recipe Generator', reason: 'Meal ideas' }, { slug: 'healthy-eating', name: 'Nutrition Analyzer', reason: 'Health tracking' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Meal planning' }],
  fitness:          [{ slug: 'fitness-skill', name: 'Workout Planner', reason: 'Personalized training' }, { slug: 'healthy-eating', name: 'Nutrition Analyzer', reason: 'Diet tracking' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Habit building' }],
  gamer:            [{ slug: 'cultivation-chronicle-cn', name: 'Game Guide', reason: 'Walkthroughs & tips' }, { slug: 'story-writer', name: 'Story Writer', reason: 'Game narratives' }, { slug: 'code-generator', name: 'Code Generator', reason: 'Mod scripting' }],
  ...
  parent:           [{ slug: 'story-writer', name: 'Story Writer', reason: 'Bedtime stories' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Family schedule' }, { slug: 'flashcards', name: 'Flashcard Maker', reason: 'Kids learning' }],
  'job-seeker':     [{ slug: 'story-writer', name: 'Story Writer', reason: 'Resume & cover letter' }, { slug: 'interview-simulator', name: 'Interview Prep', reason: 'Practice Q&A' }, { slug: 'task-planner', name: 'Task Planner', reason: 'Application tracker' }, { slug: 'translator-pro', name: 'Translator Pro', reason: 'International jobs' }],
}
