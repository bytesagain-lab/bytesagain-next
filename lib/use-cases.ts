...
export const USE_CASES: UseCase[] = [
  ...
  },
  {
    ...
    icon: '🔍',
    skills: [{ slug: 'code-generator', name: 'Code Generator', reason: 'Generates and reviews code' }, { slug: 'clawhub-spec-coder', name: 'Clawhub Spec Coder', reason: 'Spec-driven code quality' }, { slug: 'clawhub-sql-assistant', name: 'Clawhub Sql Assistant', reason: 'Reviews database queries' }],
  },
  {
  ...
  },
  {
    ...
    icon: '💰',
    skills: [{ slug: 'data-analysis', name: 'Data Analysis', reason: 'Analyzes pricing data' }, { slug: 'clawhub-lead-gen', name: 'Clawhub Lead Gen', reason: 'Market research insights' }, { slug: 'fundamental-stock-analysis', name: 'Fundamental Stock Analysis', reason: 'Competitor valuation analysis' }],
  },
  {
    ...
    icon: '🚀',
    skills: [{ slug: 'clawhub-seo-content-writer', name: 'Clawhub Seo Content Writer', reason: 'Conversion-focused copywriting' }, { slug: 'clawhub-ai-seo-writer', name: 'Clawhub Ai Seo Writer', reason: 'SEO-optimized page content' }, { slug: 'clawhub-email-drip', name: 'Clawhub Email Drip', reason: 'Consistent brand messaging' }],
  },
  {
    ...
    icon: '📧',
    skills: [{ slug: 'clawhub-email-drip', name: 'Clawhub Email Drip', reason: 'Automates email sequences' }, { slug: 'clawhub-newsletter-writer', name: 'Clawhub Newsletter Writer', reason: 'Writes engaging email content' }, { slug: 'clawhub-lead-gen', name: 'Clawhub Lead Gen', reason: 'Identifies target audience segments' }],
  },
  {
    ...
    icon: '📑',
    skills: [{ slug: 'clawhub-crypto-market-cli', name: 'Clawhub Crypto Market Cli', reason: 'Fetches crypto project data' }, { slug: 'bytesagain-quant-trader', name: 'Bytesagain Quant Trader', reason: 'Quantitative analysis framework' }, { slug: 'data-analysis', name: 'Data Analysis', reason: 'Structures whitepaper insights' }],
  },
  {
    ...
    icon: '🌾',
    skills: [{ slug: 'clawhub-crypto-market-cli', name: 'Clawhub Crypto Market Cli', reason: 'Real-time DeFi protocol data' }, { slug: 'bytesagain-quant-trader', name: 'Bytesagain Quant Trader', reason: 'Yield optimization strategies' }, { slug: 'heikinashi', name: 'Heikinashi', reason: 'Price trend analysis' }],
  },
  {
    ...
    icon: '🐋',
    skills: [{ slug: 'clawhub-crypto-market-cli', name: 'Clawhub Crypto Market Cli', reason: 'On-chain data monitoring' }, { slug: 'bytesagain-quant-trader', name: 'Bytesagain Quant Trader', reason: 'Signal interpretation' }, { slug: 'data-analysis', name: 'Data Analysis', reason: 'Wallet activity analysis' }],
  },
  {
    ...
    icon: '📊',
    skills: [{ slug: 'fundamental-stock-analysis', name: 'Fundamental Stock Analysis', reason: 'Core earnings analysis' }, { slug: 'data-analysis', name: 'Data Analysis', reason: 'Financial data processing' }, { slug: 'clawhub-excel-formula-pro', name: 'Clawhub Excel Formula Pro', reason: 'Financial model calculations' }],
  },
  {
  ...
  },
  {
    ...
    icon: '🤝',
    skills: [{ slug: 'clawhub-lead-gen', name: 'Clawhub Lead Gen', reason: 'Influencer prospect research' }, { slug: 'clawhub-email-drip', name: 'Clawhub Email Drip', reason: 'Automated outreach sequences' }, { slug: 'clawhub-newsletter-writer', name: 'Clawhub Newsletter Writer', reason: 'Compelling pitch writing' }],
  },
  {
  ...
  },
  {
    ...
    icon: '💳',
    skills: [{ slug: 'clawhub-expense-tracker', name: 'Clawhub Expense Tracker', reason: 'Expense categorization and tracking' }, { slug: 'clawhub-excel-formula-pro', name: 'Clawhub Excel Formula Pro', reason: 'Budget spreadsheet formulas' }, { slug: 'data-analysis', name: 'Data Analysis', reason: 'Spending pattern analysis' }],
  },
  {
    ...
    icon: '🧾',
    skills: [{ slug: 'clawhub-expense-tracker', name: 'Clawhub Expense Tracker', reason: 'Expense documentation' }, { slug: 'clawhub-excel-formula-pro', name: 'Clawhub Excel Formula Pro', reason: 'Tax calculation formulas' }, { slug: 'legal-document-analyzer', name: 'Legal Document Analyzer', reason: 'Tax document review' }],
  },
]
